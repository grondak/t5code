...
class TestT5Lot(unittest.TestCase):
    ...
    def test_buying_trade_class_effects(self):
        ...
        value = T5Lot.determine_buying_trade_classifications_effects(test_trade_classifications, test_trade_classifications_table)
    ...
    def test_selling_trade_class_effect(self):
        ...
        adjustment = T5Lot.determine_selling_trade_classifications_effects(marketWorld, origin_trade_classifications, selling_goods_trade_classifications_table)
    ...
    def test_lot_costs(self):
        ...
        test_trade_classifications = 'Bob Doug'
        value = T5Lot.determine_lot_cost(test_trade_classifications, test_trade_classifications_table, 5)
    ...
    def test_filter_trade_classifications(self):
        ...
        answer = T5Lot.filter_trade_classifications(provided_trade_classifications, allowed_trade_classifications)
