...
def test_load_from_json():
    ...
    json_path = Path(__file__).parent.parent / "resources" / "trade_goods_tables.json"
    ...
    # Note: Getting the name will trigger reroll, which requires "Ag" classification
    # Since "Ag" is not in our sample, we'll just verify it's an ImbalanceTradeGood
...
def test_json_structure_validation():
    ...
    for classification_code, classification_table in table.classifications.items():
