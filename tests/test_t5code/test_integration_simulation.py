...
def test_two_ships_at_same_port(game_state, ship_class):
    ...
    company1 = T5Company("Test Company 1", starting_capital=1_000_000)
    ship1 = T5Starship("Trader One", origin, ship_class, owner=company1)
    company2 = T5Company("Test Company 2", starting_capital=1_000_000)
    ship2 = T5Starship("Trader Two", origin, ship_class, owner=company2)
...
def test_ship_journey_sequence(game_state, ship_class):
    ...
    ship = T5Starship("Wanderer", origin, ship_class, owner=company)
...
def test_multiple_ships_different_routes(game_state, ship_class):
    ...
    company1 = T5Company("Test Company 1", starting_capital=1_000_000)
    ship1 = T5Starship("Route Alpha", "Rhylanor", ship_class, owner=company1)
    ...
    company2 = T5Company("Test Company 2", starting_capital=1_000_000)
    ship2 = T5Starship("Route Beta", "Jae Tellona", ship_class, owner=company2)
...
def test_concurrent_crew_hiring(game_state, ship_class):
    ...
    company1 = T5Company("Test Company 1", starting_capital=1_000_000)
    ship1 = T5Starship("Crew Ship 1", "Rhylanor", ship_class, owner=company1)
    company2 = T5Company("Test Company 2", starting_capital=1_000_000)
    ship2 = T5Starship("Crew Ship 2", "Rhylanor", ship_class, owner=company2)
...
def test_ship_status_transitions(game_state, ship_class):
    ...
    company = T5Company("Test Company ", starting_capital=1_000_000)
    ship = T5Starship("Status Test", "Rhylanor", ship_class, owner=company)
...
def test_ship_balance_persistence(game_state, ship_class):
    ...
    company = T5Company("Test Company ", starting_capital=1_000_000)
    ship = T5Starship("Money Ship", "Rhylanor", ship_class, owner=company)
...
def test_passenger_manifest_across_multiple_ships(game_state):
    ...
    company1 = T5Company("Test Company 1", starting_capital=1_000_000)
    ship1 = T5Starship("Liner One", "Rhylanor", liner_class, owner=company1)
    company2 = T5Company("Test Company 2", starting_capital=1_000_000)
    ship2 = T5Starship("Liner Two", "Rhylanor", liner_class, owner=company2)
